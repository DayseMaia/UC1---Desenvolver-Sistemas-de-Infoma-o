...
# Crie também as classes Cachorro, Gato e Pato que herdem da classe Animal e sobrescrevam o método emitir_som() para retornar 
# “au au”, “miau” e “quack” respectivamente. Crie alguns objetos dessas classes e teste o método emitir_som() em cada um.
...
# 3. Crie uma classe ContaBancaria que tenha os atributos privados numero, titular e saldo e os métodos públicos depositar(), 
# sacar() e consultar_saldo(). O método depositar() deve receber como parâmetro a quantia a ser depositada e adicionar ao saldo. 
...
# método calcular_bonus() para retornar 20%, 10% e 5% do salário respectivamente. 
